...
$$(document).on('page:init', '.page[data-name="dashboard"]', function (e){
    ...
    var sellerSerialNo = JSON.parse(window.localStorage.getItem("seller_details")).seller_serial
     

      $$("#preview-store-name").text(JSON.parse(window.localStorage.getItem("seller_details")).store_name);


      //count how many pending 
      app.request.post('https://nairasurvey.com/hub/seller_count_orders.php', 
            {

             "the_seller" : sellerSerialNo
      ...
      app.request.post('https://nairasurvey.com/hub/seller_count_acc_orders.php', 
            {
             ...
             function (data) {
                  ...
                  $$("#pending-acc-orders-count").text(data);
      ...
      app.request.post('https://nairasurvey.com/hub/seller_count_sales.php', 
            {
             ...
             function (data) {
                  ...
                  $$("#processed-orders-count").text(data);
      ...
      app.request.post('https://nairasurvey.com/hub/seller_fetch_wallet_balance.php', 
            {
   ...
   'Trustbond Mortgage Bank',
    ...
    $$("#withdrawal-form").submit(function(){
     ...
     $$("#withdrawal-btn").html("<img src='imgs/ripple.gif' style='max-width:50px;'>").prop("disabled", true);
      ...
      app.request.post('https://nairasurvey.com/hub/seller_request_withdrawal.php', 
            {
  ...
  $$(document).on('page:init', '.page[data-name="setnewpassword"]', function (e){
    ...
    $$(document).on('page:init', '.page[data-name="login"]', function (e){
          ...
          $$("#login-btn").html("<img src='imgs/ripple.gif' style='max-width:50px;'>").prop("disabled", true);
            ...
            app.request.post('https://nairasurvey.com/hub/seller_login.php', 
            {
             ...
             function (data) {
              ...
              if (data == "Invalid Login Details") {
                ...
                console.log(data);
                if (JSON.parse(data).account_type == "buyer") {

                      window.localStorage.setItem("buyer_details", data);
                      window.localStorage.removeItem("seller_details");
                        setTimeout(function(){
                        mainView.router.navigate("/dashboard/");
                      },2000);
                      ...
                      window.localStorage.setItem("seller_details", data);
...
$$(document).on('page:init', '.page[data-name="settings"]', function (e){
  ...
  var sellerSerialNo = JSON.parse(window.localStorage.getItem("seller_details")).seller_serial;
    $$("#preview-full-name").text(JSON.parse(window.localStorage.getItem("seller_details")).store_name);
    $$("#signout-btn").click(function(){

      app.dialog.progress("Signing Out...", "deeppurple");
      setTimeout(function(){
    ...
    $$("#edit-store-details").click(function(){
        app.dialog.alert("Please visit the <b>Ineed</b> web portal to update your store profile");
    });

    //get current store status
     app.request.post('https://nairasurvey.com/hub/switch.php', 
            {

             "seller_sn" : sellerSerialNo,
             ...
             function (data) {
                ...
                toastMe("Unable to switch store. Network error");
...
$$(document).on('page:init', '.page[data-name="history"]', function (e){
  ...
  app.request.post('https://nairasurvey.com/hub/seller_pull_orders.php', 
            {
...
$$(document).on('page:init', '.page[data-name="historyacc"]', function (e){


  app.request.post('https://nairasurvey.com/hub/seller_pull_acc_orders.php', 
            {
